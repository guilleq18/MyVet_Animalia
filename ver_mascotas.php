...
<!--////////////////////////////////COMIENZO DATATABLE///////////////////////////////////////////-->        
            <div>
              ...
              <td style="text-align: center;">
                 ...
                 <span style="font-size: 12px" class="btn btn-primary  btn-lg " data-toggle="modal" data-target="#modalMascota"  onclick="mascotaModificar(<?php
                   echo $Masc['id_mascotas'].',';
                   echo '"'.$Masc['nombre'].'",';
                   echo '"'.$Masc['sexo'].'",';
                   echo '"'.$Masc['tipo_demascota'].'",';
                   echo '"'.$Masc['raza'].'",';
                   echo '"'.$Masc['color'].'",';
                   echo $Masc['id_tamano'].',';
                   echo $Masc['nacimiento'];
                  ?>)">Modificar
